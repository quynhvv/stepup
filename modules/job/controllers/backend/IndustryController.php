...
use Yii;
use app\modules\job\models\JobIndustry;
...
/**
 * IndustryController implements the CRUD actions for JobIndustry model.
 */
class IndustryController extends BackendController
{
    ...
    public function actions()
    {
        return [
            'status' => [
                ...
                'modelClass' => '\app\modules\job\models\JobIndustry'
            ],
        ];
    }

    /**
     * Lists all JobIndustry models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $searchModel = new JobIndustry;
        $searchModel->scenario = 'search';
        $dataProvider = $searchModel->search($queryParams);

        Yii::$app->view->title = Yii::t($this->module->id, 'Job Industry');
        Yii::$app->view->params['breadcrumbs'][] = ['label' => Yii::t($this->module->id, 'Manage Industry'), 'url' => ['index']];
    ...
    /**
     * Displays a single JobIndustry model.
     * @param integer $_id
     * @return mixed
     */
    ...
    /**
     * Creates a new JobIndustry model.
    ...
    /**
     * Updates an existing JobIndustry model.
    ...
    /**
     * Deletes an existing JobIndustry model.
    ...
    {
        if (!Yii::$app->user->can(JobIndustry::moduleName() . ':delete'))
