...
/**
 * This is the model class for collection "job_work_type".
 *
 ...
 */
class BaseJobWorkType extends \app\components\ActiveRecord
{

    public $moduleName = 'job';

    public static $collectionName = 'job_work_type';
