...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        <div>
            <h1 class="logo-name">Stepup Carreers</h1>
        </div>
        <h3>Welcome to Stepup Carreers</h3>
...
<!--        <a href="#"><small>Forgot password?</small></a>
        ...
        <p class="m-t"> <small>Copyright Stepup Carreers. Based on Yii Framework 2.0 &copy; <?= date('Y') ?></small> </p>
    </div>
</div>
